...
?>
    ...
    <!--right container will come here-->
      <div class="card-right">
        <p>Role: External Affairs President</p>

        <div class="cards-container">
            <div class="studentCard-details">
            
            <div class="candidate-profile">
              <img src="img/candidate4.webp" alt="student-image">
            </div>

            <div class="student-info">
              <div class="candidate-name">Kojo Owusu</div>
              <div class="candidate-role">External Affairs President</div>
            </div>

            <form action="cast_vote.php" method="POST">
              <input type="hidden" name="candidateName" value="Kojo Owusu">
              <input type="hidden" name="position" value="External Affairs President">
              <input type="hidden" name="nextPage" value="Financial-Controller.php">
          ...
          <div class="studentCard2-details">
            ...
            <div class="candidate-profile">
              <img src="img/candidate5.jpg" alt="student-image">
            </div>

            <div class="student-info">
              <div class="candidate-name">Julian Carter</div>
              <div class="candidate-role">Nobody</div>
            </div>

            <form action="cast_vote.php" method="POST">
              <input type="hidden" name="candidateName" value="Julian Carter">
              <input type="hidden" name="position" value="External Affairs President">
              <input type="hidden" name="nextPage" value="Financial-Controller.php">
              <button type="submit" class="vote-btn">Vote</button>
            </form>
