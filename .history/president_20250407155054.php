...
<div class="nav-bar">
  ...
  <div class="profile">
    ...
    <div class="student-details">
      <div class="student-name"><?php echo isset($_SESSION['studentname']) ? $_SESSION['name'] : 'Guest'; ?></div>
      <div class="student-id"><?php echo htmlspecialchars($_SESSION['studentID']); ?></div>
    </div>
  </div>
</div>
