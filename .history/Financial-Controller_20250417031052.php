...
?>
    ...
    <!--right container will come here-->
      <div class="card-right">
        <p>Role: Financial Controller</p>

        <div class="cards-container">
            <div class="studentCard-details">
            
            <div class="candidate-profile">
              <img src="img/candidate6.jpg" alt="student-image">
            </div>

            <div class="student-info">
              <div class="candidate-name">Akosua Asante</div>
              <div class="candidate-role">Chairman</div>
            </div>

            <form action="cast_vote.php" method="POST">
              <input type="hidden" name="candidateName" value="Akosua Asante">
              <input type="hidden" name="position" value="Financial Controller">
              <input type="hidden" name="nextPage" value="Womens-Commissioner.php">
          ...
          <div class="studentCard2-details">
            ...
            <div class="candidate-profile">
              <img src="img/candidate8.webp" alt="student-image">
            </div>

            <div class="student-info">
              <div class="candidate-name">Sophia Hayes</div>
              <div class="candidate-role">Nobody</div>
            </div>

            <form action="cast_vote.php" method="POST">
              <input type="hidden" name="candidateName" value="Sophia Hayes">
              <input type="hidden" name="position" value="Financial Controller">
              <input type="hidden" name="nextPage" value="Womens-Commissioner.php">
              <button type="submit" class="vote-btn">Vote</button>
            </form>
  ...
  <a href="Womens-Commissioner.php" class="nextbtn-link">
