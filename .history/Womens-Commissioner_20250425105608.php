      ...
      <div class="card-right">
        ...
        <div class="cards-container">
            ...
            <div class="candidate-profile">
              <img src="img/candidate9.jpg" alt="student-image">
            </div>

            <div class="student-info">
              <div class="candidate-name">Abena Osei</div>
              <div class="candidate-role">Women's Commissioner</div>
            </div>

            <form action="cast_vote.php" method="POST">
              <input type="hidden" name="candidateName" value="Abena Osei">
              <input type="hidden" name="position" value="Women's Commissioner">
              <input type="hidden" name="nextPage" value="Deputy-Womens-Commissioner.php">
          ...
          <div class="studentCard2-details">
            ...
            <div class="candidate-profile">
              <img src="img/candidate10.jpg" alt="student-image">
            </div>

            <div class="student-info">
              <div class="candidate-name">Chloe Turner</div>
              <div class="candidate-role">Women's Commissioner</div>
            </div>

            <form action="cast_vote.php" method="POST">
              <input type="hidden" name="candidateName" value="Chloe Turner">
              <input type="hidden" name="position" value="Womens Commissioner">
              <input type="hidden" name="nextPage" value="Deputy-Womens-Commissioner.php">
              <button type="submit" class="vote-btn">Vote</button>
            </form>
          </div>
